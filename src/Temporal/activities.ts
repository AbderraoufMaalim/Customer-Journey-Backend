...
export async function inviteTosubscribe(name: string, socket: any): Promise<string> {
 // console.log(io);
...
export async function recommendProducts({ targetedProduct, productType }: JoinInput): Promise<string> {
